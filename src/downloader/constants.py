...
KENV_SKIP_FREE_SPACE_CHECKS: Final[str] = 'SKIP_FREE_SPACE_CHECKS'
...
EXIT_ERROR_NO_CERTS: Final[int] = 11
EXIT_ERROR_BAD_NEW_BINARY: Final[int] = 12
EXIT_ERROR_STORE_NOT_SAVED: Final[int] = 13
EXIT_ERROR_STORE_NOT_LOADED: Final[int] = 14
EXIT_ERROR_NETWORK_PROBLEMS: Final[int] = 15
EXIT_ERROR_FAILED_FILES: Final[int] = 20
EXIT_ERROR_FAILED_DBS: Final[int] = 21
